/* This program contains publication configuration settings; an exercise in publishing finished work.
 * The program itself is just my etended implementation of Level 31.
 * 
 * 
 * 
